...
const result = compareGenericAndLegacyInvoiceCandidates(legacy, generic, validation);
...
const descriptionEquivalent = compareGenericAndLegacyInvoiceCandidates(descriptionLegacy, descriptionGeneric, validation);
...
assert.equal(materiallyDifferentDescription.promotable, false);
